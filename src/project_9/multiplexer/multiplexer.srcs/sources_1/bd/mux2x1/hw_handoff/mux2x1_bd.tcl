...
################################################################
# This is a generated script based on design: mux2x1
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net andgate_0_q [get_bd_pins andgate_0/q] [get_bd_pins orgate_0/a]
  connect_bd_net -net andgate_1_q [get_bd_pins andgate_1/q] [get_bd_pins orgate_0/b]
  connect_bd_net -net b_1 [get_bd_ports b] [get_bd_pins andgate_1/b]
  connect_bd_net -net notgate_0_c [get_bd_pins andgate_0/b] [get_bd_pins notgate_0/c]
  connect_bd_net -net orgate_0_q [get_bd_ports q] [get_bd_pins orgate_0/q]
