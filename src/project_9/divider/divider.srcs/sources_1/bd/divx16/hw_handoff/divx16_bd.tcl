...
################################################################
# This is a generated script based on design: divx16
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net resetn_1 [get_bd_ports resetn] [get_bd_pins div_0/resetn]
  connect_bd_net -net start_1 [get_bd_ports start] [get_bd_pins div_0/start]
