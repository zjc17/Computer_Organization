...
#
# Generated by export_simulation on Sun Apr 28 19:27:20 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './divux16.sh' script.

./divux16.sh -reset_run
...
./divux16.sh -noclean_files

For more information on the script, please type './divux16.sh -help'.
