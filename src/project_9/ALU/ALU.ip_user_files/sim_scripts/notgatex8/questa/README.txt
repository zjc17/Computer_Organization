...
#
# Generated by export_simulation on Sun Apr 28 21:55:32 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './notgatex8.sh' script.

./notgatex8.sh -reset_run
...
./notgatex8.sh -noclean_files

For more information on the script, please type './notgatex8.sh -help'.
