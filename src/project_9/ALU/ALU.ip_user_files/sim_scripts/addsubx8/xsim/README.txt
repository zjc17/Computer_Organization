...
#
# Generated by export_simulation on Sun Apr 28 20:50:13 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './addsubx8.sh' script.

./addsubx8.sh -reset_run
...
./addsubx8.sh -noclean_files

For more information on the script, please type './addsubx8.sh -help'.
