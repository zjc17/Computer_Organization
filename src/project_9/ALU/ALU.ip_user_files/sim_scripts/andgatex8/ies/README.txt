...
#
# Generated by export_simulation on Sun Apr 28 21:47:35 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './andgatex8.sh' script.

./andgatex8.sh -reset_run
...
./andgatex8.sh -noclean_files

For more information on the script, please type './andgatex8.sh -help'.
