...
#
# Generated by export_simulation on Sun Apr 28 21:41:01 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './orgatex8.sh' script.

./orgatex8.sh -reset_run
...
./orgatex8.sh -noclean_files

For more information on the script, please type './orgatex8.sh -help'.
