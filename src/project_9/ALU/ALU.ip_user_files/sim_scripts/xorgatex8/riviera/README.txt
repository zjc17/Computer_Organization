...
#
# Generated by export_simulation on Sun Apr 28 23:08:26 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './xorgatex8.sh' script.

./xorgatex8.sh -reset_run
...
./xorgatex8.sh -noclean_files

For more information on the script, please type './xorgatex8.sh -help'.
