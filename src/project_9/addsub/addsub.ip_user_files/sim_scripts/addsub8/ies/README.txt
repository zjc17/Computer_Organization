...
#
# Generated by export_simulation on Tue Apr 16 11:23:46 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './addsub8.sh' script.

./addsub8.sh -reset_run
...
./addsub8.sh -noclean_files

For more information on the script, please type './addsub8.sh -help'.
