...
module Idecode32(read_data_1,read_data_2,Instruction,read_data,ALU_result,
   ...
   wire[31:0] read_data_1;
        ...
        assign Sign_extend[31:0] = (opcode==6'b001100||opcode==6'b001101||opcode==6'b001110||opcode==6'b001011)?{{16{1'b0}},Instruction_immediate_value}:{{16{sign}},Instruction_immediate_value};
        ...
        always @(posedge clock) begin       // 本进程写目标寄存器
            if(reset==1) begin              // 初始化寄存器组
                ...
                if(write_register_address == 5'd0)
                begin
                    register[write_register_address] <= 32'd0;
                end 
                else
                begin
