...
#
# Generated by Vivado on Thu May 30 23:43:48 +0800 2019
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="F:/Github/Computer_Organization/src/project_14/project_14.cache/compile_simlib/activehdl"
  fi
